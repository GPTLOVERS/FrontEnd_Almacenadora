...
export const Navbar = () => {
  ...
  const handleGoToRegistrarProductos = () =>
    navigate("/productos/agregarProducto");
  const handleGoToEditarProductos = () => navigate("/productos/update");
  const handleGoToElimanarProductos = () =>
    navigate("/productos/DeleteProducto");
            ...
            <>
              ...
              >
                ...
                {isDropdownOpen.producto && (
                  <div className="dropdown-content">
                    ...
                    <span onClick={handleGoToRegistrarProductos}>
                      Agregar Productos
                    </span>
                    <span onClick={handleGoToEditarProductos}>
                      Editar Productos
                    </span>
                    <span onClick={handleGoToElimanarProductos}>
                      Eliminar Productos
                    </span>
                  </div>
                )}
              ...
              >
                ...
                {isDropdownOpen.proveedores && (
                  <div className="dropdown-content">
                    <span onClick={handleGoToVerProveedores}>
                      Ver Proveedores
                    </span>
                    <span onClick={handleGoToRegistrarProveedores}>
                      Agregar Proveedores
                    </span>
                    <span onClick={handleGoToEditarProveedores}>
                      Editar Proveedores
                    </span>
                    <span onClick={handleGoToBuscarProveedores}>
                      Buscar Proveedores
                    </span>
                  </div>
                )}
              ...
              >
                ...
                {isDropdownOpen.stats && (
                  <div className="dropdown-content">
                    ...
                    <span onClick={handleDowloadInventory}>
                      Descargar Inventario
                    </span>
                    <span onClick={handleGotoMovements}>
                      Descargar Reporte de Vomientos
                    </span>
                  </div>
                )}
              </div>
